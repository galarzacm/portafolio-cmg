    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 30% 40%, rgba(59, 130, 246, 0.1) 0%, transparent 50%), radial-gradient(circle at 70% 80%, rgba(139, 92, 246, 0.08) 0%, transparent 50%)",
          }}
        />
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto pt-12">
        ...
        >
          <h1
            className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight max-w-3xl mx-auto"
        ...
        >
          ...
          >
            Licenciado en Tecnología de la Información y Desarrollador Backend
            con énfasis en Node.js, NestJS, Express, TypeORM, Prisma, PostgreSQL
            y MongoDB. Me apasiona diseñar y construir APIs escalables, seguras
            y fáciles de mantenar, aplicando buenas prácticas de arquitectura,
            patrones de diseño y clean code. Disfruto trabajar en equipos
            ágiles, aprender tecnologías nuevas y colaborar para crear
            soluciones que realmente aporten valor. Vengo del área
            administrativa/financiera, lo cual me da una visión sólida del
            negocio y de la importancia de la calidad, la eficiencia y el
            impacto real en los procesos. Actualmente busco oportunidades
            remotas part-time donde pueda contribuir en proyectos de back-end
            con propósito, mientras continúo creciendo como profesional.{" "}
          </p>
        </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
            <Button
              onClick={() => {
                ...
                link.href = "/Cristian_Galarza_Fullstack_Backend_CV.pdf";
                link.download = "Cristian_Galarza_Fullstack_Backend_CV.pdf";
                link.click();
              }}
              variant="outline"
